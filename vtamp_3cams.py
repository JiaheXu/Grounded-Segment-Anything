...
class grounded_sam():
    def __init__(self, args):
        ...
        self.cam1_intrinsic = np.array([
            [739.1656494140625, 0., 951.3283081054688],
            [0. ,739.1656494140625,  566.4527587890625],
            [0., 0., 1.0]
        ])
        ...
        self.trans = []
        self.trans.append( self.get_transform( [0.407, -0.748, 0.380], [0.869, -0.022, 0.001, -0.495]) )#rosrun tf tf_echo  map cam1
        self.trans.append( self.get_transform( [-0.026, -0.540, 0.460], [0.755, -0.393, 0.255, -0.459]) )
        self.trans.append( self.get_transform( [0.921, -0.011, 0.490], [0.319, 0.831, -0.413, -0.192]) )
