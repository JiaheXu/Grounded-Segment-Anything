...
class grounded_sam():
    def __init__(self, args):
        ...
        self.point_cloud_pub = rospy.Publisher("zedxm/gsa_point_cloud2", PointCloud2, queue_size=1)
        self.object_depth_pub = rospy.Publisher("zedxm/gsa_objects_depth", Image, queue_size=1)
...
def demo(args):
    rospy.init_node("zedxm_grounded_sam_node")
