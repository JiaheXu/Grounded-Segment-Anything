...
class grounded_sam():
    def __init__(self, args):
        ...
        self.cam_intrinsic = np.array([
            [734.4661865234375, 0., 962.6373901367188],
            [0. ,734.4661865234375,  570.3966064453125],
            [0., 0., 1.0]
        ])
        ...
        self.point_cloud_pub = rospy.Publisher("cam2/gsa_point_cloud2", PointCloud2, queue_size=1)
...
if __name__ == "__main__":
    ...
    ##############################################
    parser.add_argument('--left_topic', type=str, default="/cam2/zed_node_B/left/image_rect_color", help="left cam topic")
    parser.add_argument('--right_topic', type=str, default="/cam2/zed_node_B/right/image_rect_color", help="right cam topic")
    parser.add_argument('--depth_topic', type=str, default="/cam2/zed_node_B/depth/depth_registered", help="depth cam topic")
    parser.add_argument('--conf_map_topic', type=str, default="/cam2/zed_node_B/confidence/confidence_map", help="depth confidence map topic")
    ##############################################
